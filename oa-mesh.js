...
angular.module('oaMesh', ['oaSylvester', 'oaUtil']).factory('oaMesh', ['oaSylvester', 'oaIndexProvider', function (oaSylvester, oaIndexProvider) {
  function oaMesh(_options) {
    ...
    this.addVertex = function (v) {
      if (!bufferIndicies.capacity) {
        if (options.maximumSize && buffer.byteLength >= options.maximumSize) throw 'maximum size reached';
        this.grow();
      }
