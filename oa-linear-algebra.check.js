...
angular.module('oaLinearAlgebraTestApp', ['oaLinearAlgebra']).controller('RectTestCtrl', ['$scope', 'oaRectangular', 'oaPolar', 'oaCartesian', 'oaCylindrical', 'oaSpherical', 'oaHomogeneous', function ($scope, oaRectangular, oaPolar, oaCartesian, oaCylindrical, oaSpherical, oaHomogeneous) {
