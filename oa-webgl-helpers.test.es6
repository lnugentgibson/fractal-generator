...
\${D("functionDefinitions", "null")}`;
          ...
          describe('parameter set #' + (i + 1) + ': snippet value', function() {
            ...
            beforeEach(function() {
              ...
              vertexShaderSnippet.setParameterValue('functionDeclarations', [
                'randScalarDec',
                'randVectorDec',
                'randGradDec',
                'noiseDec'
              ]);
              vertexShaderSnippet.setParameterValue('functionDefinitions', [
                'randScalarDef',
                'randVectorDef',
                'randGradDef',
                'noiseDef'
...
gl_FragColor = vec4(vec3(noise(op) * 0.5 + 0.5), 1.0);`;
            ...
            fragmentShaderSnippet.setParameterValue('functionDeclarations', [
              'randScalarDec',
              'randVectorDec',
              'randGradDec',
              'noiseDec'
            ]);
            fragmentShaderSnippet.setParameterValue('functionDefinitions', [
              'randScalarDef',
              'randVectorDef',
              'randGradDef',
              'noiseDef'
