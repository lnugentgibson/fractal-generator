          ...
          describe('parameter set #' + (i + 1) + ': ' + snippetSource.name, function () {
            ...
            beforeEach(function () {
              ...
              snippetSource.parameters.forEach(function (parameter) {
                ...
                if (value != undefined) snippet.setParameterValue(name, value);
              });
              var options = snippetSource.options;
              if (options) Object.keys(options).forEach(function (option) {
                snippet.setParameterValue(option, options[option]);
              });
            });
      ...
      if (false) describe('B', function () {
        ...
        describe('parameter set #' + (i + 1) + ': snippet value', function () {
          ...
          beforeEach(function () {
            ...
            vertexShaderSnippet.setParameterValue('attributes', ['attribute vec4 a_position;']);
            vertexShaderSnippet.setParameterValue('body.indent', 1);
      ...
      if (false) describe('C', function () {
        ...
        describe('parameter set #' + (i + 1) + ': snippet value', function () {
          ...
          beforeEach(function () {
            vertexShaderInnerSnippet = new $oaWebglSnippet();
            vertexShaderInnerSnippet.source = 'gl_Position = a_position;';
            vertexShaderSnippet.setParameterValue('variables', [{
              vartype: 'attribute',
              datatype: 'vec4',
              varname: 'a_position'
            }]);
      ...
      if (true) describe('D', function () {
        ...
        describe('parameter set #' + (i + 1) + ': snippet value', function () {
          ...
          beforeEach(function () {
            ...
            vertexShaderSnippet.setParameterValue('functionDeclarations', ['randScalarDec', 'randVectorDec', 'randGradDec', 'noiseDec']);
            vertexShaderSnippet.setParameterValue('functionDefinitions', ['randScalarDef', 'randVectorDef', 'randGradDef', 'noiseDef']);
            vertexShaderSnippet.setParameterValue('body.indent', 1);
            vertexShaderInnerSnippet = new $oaWebglSnippet();
    ...
    describe('oaWebglFunctionSnippet factory', function () {
      ...
      if (true) {
        describe('parameter set #' + (i + 1) + ': snippet value', function () {
          ...
          beforeEach(function () {
            fragmentShaderSnippet.setParameterValue('variables', [{
              vartype: 'uniform',
              datatype: 'vec4',
              varname: 'u_seed'
            }, {
            ...
            fragmentShaderSnippet.setParameterValue('body.indent', 1);
            ...
            fragmentShaderSnippet.setParameterValue('functionDeclarations', ['randScalarDec', 'randVectorDec', 'randGradDec', 'noiseDec']);
            fragmentShaderSnippet.setParameterValue('functionDefinitions', ['randScalarDef', 'randVectorDef', 'randGradDef', 'noiseDef']);
            // randScalar
            {
    ...
    describe('oaWebglSnippet factory', function () {
      ...
      describe('A', function () {
        it('should instantiate', function () {
          snippet = new $oaWebglSnippet('test-snippet #1', 'testing');
        });
      });

      describe('B', function () {
        beforeEach(function () {
          snippet = new $oaWebglSnippet('test-snippet #2', 'testing');
        });

        it('should add parameter 1 without errors', function () {
          snippet.addParameter($oaWebglSnippet.PARAMTYPE_VALUE, 'param1');
        });
        it('should add parameter 2 without errors', function () {
          snippet.addParameter($oaWebglSnippet.PARAMTYPE_VALUE, 'obj1.arr1[17].param3', {
