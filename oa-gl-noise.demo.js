...
angular.module('oaGLSLNoiseDemo', ['oaGLSLNoise']).controller('NoiseTestCtrl', ['$scope', 'oaWebglHelpers', 'oaWebglCanvas', 'oaWebglProgram', 'oaWebglShaderSource', 'oaWebglShaderSnippet', 'oaWebglFunctionSnippet', 'oaWebglSnippet', 'oaNoiseShaderFunctions', function ($scope, oaWebglHelpers, oaWebglCanvas, oaWebglProgram, oaWebglShaderSource, oaWebglShaderSnippet, oaWebglFunctionSnippet, oaWebglSnippet, oaNoiseShaderFunctions) {
  ...
  if (true) {
    ...
    var Canvas2 = new oaWebglCanvas(name, $canvas2[0], options);{
      ...
      sineGradientNoiseFragment.addFunctions([oaNoiseShaderFunctions.functions.rand11Function, oaNoiseShaderFunctions.functions.rand22RotFunction]);
      var sineGradientNoiseFragmentBody = new oaWebglSnippet('sineGradientNoiseFragmentBody', 'vec2 grad = rand2Rot(floor(gl_FragCoord.xy / u_resolution));\ngl_FragColor = vec4(grad * 0.5 + vec2(0.5), length(grad), 1.0);');
  ...
  if (true) {
    ...
    var Canvas3 = new oaWebglCanvas(name, $canvas3[0], options);{
      ...
      perlinNoiseFragment.addFunctions([oaNoiseShaderFunctions.functions.rand11Function, oaNoiseShaderFunctions.functions.rand12Function, oaNoiseShaderFunctions.functions.mix1Function, oaNoiseShaderFunctions.functions.curve5Function, oaNoiseShaderFunctions.functions.mix5Function, oaNoiseShaderFunctions.functions.perlin2NoiseFunction]);
  ...
  if (true) {
    ...
    var Canvas4 = new oaWebglCanvas(name, $canvas4[0], options);{
      ...
      perlinGradientNoiseFragment.addFunctions([oaNoiseShaderFunctions.functions.rand11Function, oaNoiseShaderFunctions.functions.rand22RotFunction, oaNoiseShaderFunctions.functions.mix1Function, oaNoiseShaderFunctions.functions.curve5Function, oaNoiseShaderFunctions.functions.mix5Function, oaNoiseShaderFunctions.functions.perlin2GradientNoiseFunction]);
      grayscale = oaNoiseShaderFunctions.snippets.grayscaleSnippet();
  ...
  if (true) {
    ...
    var Canvas6 = new oaWebglCanvas(name, $canvas6[0], options);{
      ...
      simplexNoiseFragment.addFunctions([oaNoiseShaderFunctions.functions.rand11Function, oaNoiseShaderFunctions.functions.rand12Function, oaNoiseShaderFunctions.functions.mix1Function, oaNoiseShaderFunctions.functions.curve5Function, oaNoiseShaderFunctions.functions.mix5Function, oaNoiseShaderFunctions.functions.simplex2NoiseFunction]);
      grayscale = oaNoiseShaderFunctions.snippets.grayscaleSnippet();
  ...
  if (true) {
    ...
    var Canvas7 = new oaWebglCanvas(name, $canvas7[0], options);{
      ...
      simplexGradientNoiseFragment.addFunctions([oaNoiseShaderFunctions.functions.rand11Function, oaNoiseShaderFunctions.functions.rand22RotFunction, oaNoiseShaderFunctions.functions.mix1Function, oaNoiseShaderFunctions.functions.curve5Function, oaNoiseShaderFunctions.functions.mix5Function, oaNoiseShaderFunctions.functions.simplex2GradientNoiseFunction]);
      grayscale = oaNoiseShaderFunctions.snippets.grayscaleSnippet();
  ...
  if (false) {
    ...
    var Canvas10 = new oaWebglCanvas(name, $canvas10[0], options);{
      ...
      fractalSimplexGradientNoiseFragment.addFunctions([oaNoiseShaderFunctions.functions.rand11SeededFunction, oaNoiseShaderFunctions.functions.rand22RotSeededFunction, oaNoiseShaderFunctions.functions.mix1Function, oaNoiseShaderFunctions.functions.curve3Function, oaNoiseShaderFunctions.functions.mix3Function, oaNoiseShaderFunctions.functions.curve5Function, oaNoiseShaderFunctions.functions.mix5Function, oaNoiseShaderFunctions.functions.simplexGradientNoiseSeededFunction]);
      grayscale = oaNoiseShaderFunctions.snippets.grayscaleSnippet();
      ...
      fractalSimplexGradientNoiseFragmentBody.source = 'float value = mix3(-0.5, 1.5, simplexGradient(gl_FragCoord.xy / 512.0, u_seed)) - 0.5;\nvalue += (mix3(-0.5, 1.5, simplexGradient(gl_FragCoord.xy / 256.0, u_seed + mat4(vec4(vec2(0.0), 1294.62285, 3843.97555), vec4(0.0), vec4(0.0), vec4(0.0)))) - 0.5) / 2.0;\nvalue += (mix3(-0.5, 1.5, simplexGradient(gl_FragCoord.xy / 128.0, u_seed + mat4(vec4(vec2(0.0), 8015.69457, 4157.59618), vec4(0.0), vec4(0.0), vec4(0.0)))) - 0.5) / 4.0;\nvalue += (mix3(-0.5, 1.5, simplexGradient(gl_FragCoord.xy / 64.0, u_seed + mat4(vec4(vec2(0.0), 1055.22700, 8985.03880), vec4(0.0), vec4(0.0), vec4(0.0)))) - 0.5) / 8.0;\nvalue += (mix3(-0.5, 1.5, simplexGradient(gl_FragCoord.xy / 32.0, u_seed + mat4(vec4(vec2(0.0), 3321.91072, 3115.67531), vec4(0.0), vec4(0.0), vec4(0.0)))) - 0.5) / 16.0;\nvalue += (mix3(-0.5, 1.5, simplexGradient(gl_FragCoord.xy / 16.0, u_seed + mat4(vec4(vec2(0.0), 9392.20107, 8588.83631), vec4(0.0), vec4(0.0), vec4(0.0)))) - 0.5) / 32.0;\nvalue += (mix3(-0.5, 1.5, simplexGradient(gl_FragCoord.xy / 8.0, u_seed + mat4(vec4(vec2(0.0), 6230.83333, 2164.97665), vec4(0.0), vec4(0.0), vec4(0.0)))) - 0.5) / 64.0;\nvalue += (mix3(-0.5, 1.5, simplexGradient(gl_FragCoord.xy / 4.0, u_seed + mat4(vec4(vec2(0.0), 8503.51831, 3157.07155), vec4(0.0), vec4(0.0), vec4(0.0)))) - 0.5) / 128.0;\nvalue += (mix3(-0.5, 1.5, simplexGradient(gl_FragCoord.xy / 2.0, u_seed + mat4(vec4(vec2(0.0), 1354.34785, 3309.93363), vec4(0.0), vec4(0.0), vec4(0.0)))) - 0.5) / 256.0;\nvalue += (mix3(-0.5, 1.5, simplexGradient(gl_FragCoord.xy, u_seed + mat4(vec4(vec2(0.0), 2464.58509, 2852.88723), vec4(0.0), vec4(0.0), vec4(0.0)))) - 0.5) / 512.0;\nvalue += 0.5;\ngl_FragColor = ${S("grayscale", "null")};';
